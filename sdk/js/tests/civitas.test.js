...
describe('Civitas.getHistory', () => {
    ...
    it('should call fetch with limit=100 if limit is undefined', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(
            'https://api.erethiel.com/v1/verified/chat/completions?limit=100',
    ...
    it('should call fetch with provided limit if limit is a positive number', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledTimes(1);
        expect(global.fetch).toHaveBeenCalledWith(
            `https://api.erethiel.com/v1/verified/chat/completions?limit=${mockLimit}`,
            expect.objectContaining({
                method: 'GET',
                headers: {
                    Accept: 'application/json',
    ...
    it('should call fetch with provided filter mine', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledTimes(1);
        expect(global.fetch).toHaveBeenCalledWith(
            `https://api.erethiel.com/v1/verified/chat/completions?limit=${mockLimit}&filter=mine`,
            expect.objectContaining({
                method: 'GET',
                headers: {
                    Accept: 'application/json',
    ...
    it('should call fetch with provided filter all', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledTimes(1);
        expect(global.fetch).toHaveBeenCalledWith(
            `https://api.erethiel.com/v1/verified/chat/completions?limit=${mockLimit}&filter=all`,
            expect.objectContaining({
                method: 'GET',
                headers: {
                    Accept: 'application/json',
